                                ...
                                <Card sx={{
                                    ...
                                    <CardContent>
                                        ...
                                        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", height: "250px" }}>
                                            <img src={process.env.NODE_ENV === "development" ? require('../../assets/images/' + gateway.name + '.png') : 'https://www.dacona.ro/static/media/' + gateway.name + '.png'} alt={gateway.name} style={{ width: "100%", height: "100%", objectFit: "contain" }} />
                                        </Box>
                                    ...
                                    <CardActions sx={{ height: "100px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                        <Button size="small" variant='contained' onClick={() => { navigate(`/teltonika/gateways/${gateway.id}`) }} sx={{ backgroundColor: "#008478", padding: 1, "&:hover": { backgroundColor: "#034640" } }}>Mode details</Button>
                                    </CardActions>
                                </Card>
                            </Grid>
                        )
